...
\itemListStart
  ...
  \myItem{Designed and verified a \textbf{3-hop directory cache-coherence protocol} (MSI/MESI) in Mur$\phi$; optimized with \textbf{Exclusive (E)} state to eliminate bus transactions (\textbf{0 MB} overhead vs 80 MB baseline).}\href{https://github.com/YueFei0403/Murphi3.1-CacheCoherence/tree/main/ece1755_sample}{[Code]}
\itemListEnd
}
